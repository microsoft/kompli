...
Result<Status> EnsureFilePermissionsCollectionHelper(const FilePermissionsCollectionParams& params, IndicatorsTree& indicators, ContextInterface& context, bool isRemediation)
{

...
#ifndef COMPLIANCE_ENGINE_BENCHMARKIO_INPUT_SECURITY_HPP
#define COMPLIANCE_ENGINE_BENCHMARKIO_INPUT_SECURITY_HPP
...
#endif // COMPLIANCE_ENGINE_BENCHMARKIO_INPUT_SECURITY_HPP
